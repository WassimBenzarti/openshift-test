...
require_once(getenv("OPENSHIFT_REPO_DIR")."php/connect.php");
  ...
  function share($url,$caption,$image){
  ...
  if(isset($_GET['upload'])){
    $res = share("https://graph.facebook.com/me/photos?".testPTOKEN,"hello","https://www.moooi.com/sites/default/files/styles/large/public/product-images/random_detail.jpg?itok=ErJveZTY");
    echo "<pre>";
